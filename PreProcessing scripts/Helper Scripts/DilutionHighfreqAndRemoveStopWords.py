...
filer = os.path.join(CURRENT_DIR,'/Users/hadihamoud/Desktop/FYPEPIC/FYP/Dave-server/data/Combined_Books/CombinedjsontestemrNoStopWordsALlNotesAndPubmedTop4.txt')
f = open(filer,'r')
#----------------------------------------StopWords
data = f.read()
...
#----------------------------high frequency Uncomment below and comment above 
