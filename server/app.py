...
def change_book():
    ...
    manager.set_book(choice = chosen_book_number)
...
def add_note():
    ...
    response_data = manager.get_graphs_and_scores(text = text, start_rank= 1, num_graphs = 3)
...
def get_rest_of_notes():
    response_data = manager.get_graphs_and_scores(start_rank= 4, num_graphs = 3)
    return jsonify(response_data)
